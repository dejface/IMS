...
\begin{document}
	...
	%Možno tu ešte niečo dopísať I am Lost ja tu este dopisem sracky z tej studie a vysvetlim jednotlive vyznamy opatreni, ale teraz no energy to do such a thing.
	
	%niekde napcham aj overovanie validity pomcou tej kalkulacky a aj podla niektorzch tych mapiek
	%vlastne mam cely zoznam veci ktore tu chcem napisat, mam to na papieri co vsetko :D
	%len neviem do akych kapitol mam rozobrat tu studiu, ze ci tu v rozbore alebo inde
    ...
    Na základe týchto opatrení skúmame šírenie vírusu medzi návštevníkmi počas filmu. Predpokladáme vždy, že je sála vypredaná a teda všetky miesta, na ktorých je práve umožnené sedieť, sú obsadené. Sála je pred každým predstavením riadne vydezinkfikovaná, aby sa zabránilo čiastočkám vírusu na povrchoch.
        ...
        % tu by som doplnil este mozno pravidla automatu, ze ako sa menia stavy
